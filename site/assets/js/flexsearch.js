...
/*!
  ...
  The flexsearch.js in the Dok module is overridden with this patched copy because the
  original one has a bug, that prevents searches from working correctly when the
  base URL contains a path prefix. See: https://github.com/thuliteio/doks/issues/1275

  This copy of flezxsearch.js is applying the workaround mentioned at:
  https://github.com/thuliteio/doks/discussions/1207#discussioncomment-9521322

  This file can be removed if Dok is updated to a more recent version where this issue
  is fixed.
 */
