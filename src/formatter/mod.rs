...
impl Formatter {
        ...
        W: std::io::Write,
    {
        ...
        // After parsing the source code we get an iterator that returns the
        // top-level elements of the parse tree. Each element in this CST
        // is a pair composed of a parsing rule generated by Pest and its
