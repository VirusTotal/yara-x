...
pub struct Modules {
    ...
    // @@protoc_insertion_point(field:mods.Modules.vsix)
    pub vsix: ::protobuf::MessageField<super::vsix::Vsix>,
    // special fields
...
impl Modules {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::msi::Msi>(
            "msi",
            |m: &Modules| { &m.msi },
            |m: &mut Modules| { &mut m.msi },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::vsix::Vsix>(
            "vsix",
            |m: &Modules| { &m.vsix },
            |m: &mut Modules| { &mut m.vsix },
        ));
...
impl ::protobuf::Message for Modules {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.vsix)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.vsix.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
    ...
    fn default_instance() -> &'static Modules {
        static instance: Modules = Modules {
            ...
            vsix: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bmacho.proto\x1a\x0bolecf.proto\x1a\tvba.proto\x1a\tmsi.proto\x1a\nvs\
    ix.proto\"\xd9\x02\n\x07Modules\x12\x16\n\x02pe\x18\x01\x20\x01(\x0b2\
    \x06.pe.PER\x02pe\x12\x1a\n\x03elf\x18\x02\x20\x01(\x0b2\x08.elf.ELFR\
    \x03elf\x12&\n\x06dotnet\x18\x03\x20\x01(\x0b2\x0e.dotnet.DotnetR\x06dot\
    net\x12\"\n\x05macho\x18\x04\x20\x01(\x0b2\x0c.macho.MachoR\x05macho\x12\
    \x1a\n\x03lnk\x18\x05\x20\x01(\x0b2\x08.lnk.LnkR\x03lnk\x12\"\n\x05olecf\
    \x18\x06\x20\x01(\x0b2\x0c.olecf.OlecfR\x05olecf\x12\x1a\n\x03vba\x18\
    \x07\x20\x01(\x0b2\x08.vba.VbaR\x03vba\x12\x1a\n\x03crx\x18\x08\x20\x01(\
    \x0b2\x08.crx.CrxR\x03crx\x12\x1a\n\x03dex\x18\t\x20\x01(\x0b2\x08.dex.D\
    exR\x03dex\x12\x1a\n\x03msi\x18\n\x20\x01(\x0b2\x08.msi.MsiR\x03msi\x12\
    \x1e\n\x04vsix\x18\x0b\x20\x01(\x0b2\n.vsix.VsixR\x04vsixb\x06proto2\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::vsix::file_descriptor().clone());
