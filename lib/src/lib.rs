...
pub use models::Rule;
pub use modules::CustomModule;
pub use modules::CustomModuleDescriptorFn;
pub use modules::CustomModuleMainFn;
...
/// Re-export of the [`inventory`](https://docs.rs/inventory) crate.
///
/// Available when the `custom-modules` feature is enabled. External crates
/// that register [`CustomModule`]s can use this re-export to guarantee they
/// link against the exact same version of `inventory` as `yara-x`.
#[cfg(feature = "custom-modules")]
pub use inventory;

/// Opaque scan context passed as first argument to functions exported from a
/// [`CustomModule`] via `#[yara_x::module_export(yara_x_crate = "yara_x")]`.
///
/// Functions only receive a reference to it; all fields are private.
#[cfg(feature = "custom-modules")]
pub type ScanContext<'r, 'd> = scanner::ScanContext<'r, 'd>;

/// Attribute macro for exporting a callable function from a [`CustomModule`].
///
...
// The items below are used exclusively by code generated by the macros above.
// They are not part of the stable public API.
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
pub type Caller<'a, T> = wasmtime::Caller<'a, T>;
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
pub type WasmExport = wasm::WasmExport;
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
pub type WasmExportedFn0<R> = wasm::WasmExportedFn0<R>;
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
pub type WasmExportedFn1<A1, R> = wasm::WasmExportedFn1<A1, R>;
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
pub type WasmExportedFn2<A1, A2, R> = wasm::WasmExportedFn2<A1, A2, R>;
#[cfg(feature = "custom-modules")]
#[doc(hidden)]
