...
use crate::{Rule, re, teddy, types, wasm};
...
/// the length of the scanned data allows it, the Teddy scanner is used
/// because it is faster. In all other cases, the Aho-Corasick automaton is
/// used.
